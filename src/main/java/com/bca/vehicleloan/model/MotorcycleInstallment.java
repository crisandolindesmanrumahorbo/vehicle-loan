...
public class MotorcycleInstallment extends VechicleInstallment {
    ...
    public MotorcycleInstallment(int price, String condition, int createdYear, int downPayment, int tenor) {
        this.createdYear = getCreatedYear(createdYear);
        this.isNew = isNew(condition, this.createdYear);
        this.baseInterest = 0.09f;
